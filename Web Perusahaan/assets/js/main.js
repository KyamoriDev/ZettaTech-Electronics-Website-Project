...
if (formDropdown) {
    ...
    const menu = formDropdown.querySelector('.dropdown__menu');
    ...
    toggle.addEventListener('click', () => {
        ...
        if (formDropdown.classList.contains('open')) {
            icon.classList.remove('bx-chevron-down-circle');
            icon.classList.add('bx-chevron-up-circle');
            menu.style.display = 'block';
        } else {
            icon.classList.remove('bx-chevron-up-circle');
            icon.classList.add('bx-chevron-down-circle');
    ...
    menuItems.forEach(item => {
        item.addEventListener('click', (e) => {
            e.preventDefault();
            toggle.innerHTML = item.textContent + " <i class='bx bx-chevron-down-circle'></i>";
